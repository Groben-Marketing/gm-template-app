...
- **`.github/sync-config.json`** — added `docs/agent-verification.md`, `docs/ai-collaboration.md`, `docs/spec-writing-guide.md`, `.claude/commands/qa.md`, `.claude/commands/work-issue.md`, `scripts/verify.sh` to the synced files list.
